...
1.  In return for the permission and support provided by **[Host Organization]** to access [Place] for research purposes, Participants in scientific Research Projects (hereinafter "Projects") agree to contribute to the conservation and sustainable use of the [Place] by participating in the **[Place] IDEA**, contributing to the **[Place] Data trust**, and abiding by the **IDEA Consortium Code of Conduct** (see [Exhibit -- IDEA Code of Conduct](#exhibit-idea-code-of-conduct)).
