...
6.  TS personnel and other IDEA Consortium collaborators who have agreed to abide by the IDEA Code of Conduct are ~~If an embargo period is granted,~~ allowed pre-publication access and use of ~~the embargoed~~ data ~~is still permitted for~~during any embargo period  ~~TS personnel and other IDEA Consortium collaborators who have agreed to abide by the IDEA Code of Conduct~~ (see Exhibit 1).\
    \
